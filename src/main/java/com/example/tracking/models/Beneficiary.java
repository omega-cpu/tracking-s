...
public class Beneficiary  extends Auditable<String> {
    ...
    public Beneficiary(int id, String policynumber, String name, String percentage, String dob, String relation,
    ...
    public String toString() {
        return "Beneficiary [comment=" + comment + ", dob=" + dob + ", id=" + id + ", location=" + location + ", name="
